...
from juju_linode.config import Config
from juju_linode.constraints import SERIES_MAP
from juju_linode.exceptions import (
    ConfigError, PrecheckError, ProviderAPIError)
from juju_linode import commands
...
PLUGIN_DESCRIPTION = "Juju Linode client-side provider"
...
def setup_parser():
    ...
    list_machines.add_argument(
        ...
        help="Display all linode_instaces in linode.")
